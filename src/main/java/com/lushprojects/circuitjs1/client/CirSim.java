...
import com.lushprojects.circuitjs1.client.dialogs.AboutBox;
import com.lushprojects.circuitjs1.client.dialogs.EditDialog;
import com.lushprojects.circuitjs1.client.dialogs.Editable;
import com.lushprojects.circuitjs1.client.dialogs.ExportAsLocalFileDialog;
import com.lushprojects.circuitjs1.client.dialogs.ExportAsTextDialog;
import com.lushprojects.circuitjs1.client.dialogs.ExportAsUrlDialog;
import com.lushprojects.circuitjs1.client.dialogs.ImportFromDropbox;
import com.lushprojects.circuitjs1.client.dialogs.ImportFromDropboxDialog;
import com.lushprojects.circuitjs1.client.dialogs.ImportFromTextDialog;
import com.lushprojects.circuitjs1.client.dialogs.ScrollValuePopup;
import com.lushprojects.circuitjs1.client.elements.*;
import com.lushprojects.circuitjs1.client.support.CircuitElementSupport;
import com.lushprojects.circuitjs1.client.support.CircuitNode;
import com.lushprojects.circuitjs1.client.support.CircuitNodeLink;
import com.lushprojects.circuitjs1.client.support.LoadFile;
import com.lushprojects.circuitjs1.client.support.MyCommand;
import com.lushprojects.circuitjs1.client.support.QueryParameters;
import com.lushprojects.circuitjs1.client.support.RowInfo;
import com.lushprojects.circuitjs1.client.support.StringTokenizer;
import com.lushprojects.circuitjs1.client.ui.CheckboxAlignedMenuItem;
...
public class CirSim implements MouseDownHandler, MouseMoveHandler, MouseUpHandler, ClickHandler, DoubleClickHandler,
    ...
    public CheckboxMenuItem scopeRMSMenuItem;
    ...
    public CheckboxMenuItem scopeMaxScaleMenuItem;
    public CheckboxMenuItem scopeMaxScaleTransMenuItem;
    ...
    public NumberFormat showFormat, shortFormat;
    ...
    int scopeColCount[];
    public static EditDialog editDialog, customLogicEditDialog;
	...
	for (i = 0; i != colorScaleCount; i++) {
		...
		int n1 = (int) (128 * v) + 127;
		int n2 = (int) (127 * (1 - v));
		if (alternativeColorCheckItem.getState())
	...
	// m.addItem(new CheckboxAlignedMenuItem(LS("Scale 2x"), new
	// MyCommand("scopepop", "scale")));
	CheckboxMenuItem mi;
	...
	if (!t)
	    m.addItem(scopeRemovePlotMenuItem = new CheckboxAlignedMenuItem(LS("Remove Plot"),
	...
	if (t) {
	    ...
	    m.addItem(scopeVceIcMenuItem = new CheckboxMenuItem(LS("Show Vce vs Ic"),
		    new MyCommand("scopepop", "showvcevsic")));
	} else {
	    m.addItem(scopeVMenuItem = new CheckboxMenuItem(LS("Show Voltage"),
		    new MyCommand("scopepop", "showvoltage")));
	    m.addItem(scopeIMenuItem = new CheckboxMenuItem(LS("Show Current"),
		    new MyCommand("scopepop", "showcurrent")));
	    m.addItem(scopePowerMenuItem = new CheckboxMenuItem(LS("Show Power Consumed"),
		    new MyCommand("scopepop", "showpower")));
	    m.addItem(scopeScaleMenuItem = new CheckboxMenuItem(LS("Show Scale"),
		    new MyCommand("scopepop", "showscale")));
	    m.addItem(scopeMaxMenuItem = new CheckboxMenuItem(LS("Show Peak Value"),
		    new MyCommand("scopepop", "showpeak")));
	    m.addItem(scopeMinMenuItem = new CheckboxMenuItem(LS("Show Negative Peak Value"),
		    new MyCommand("scopepop", "shownegpeak")));
	    m.addItem(scopeFreqMenuItem = new CheckboxMenuItem(LS("Show Frequency"),
		    new MyCommand("scopepop", "showfreq")));
	    m.addItem(
		    scopeFFTMenuItem = new CheckboxMenuItem(LS("Show Spectrum"), new MyCommand("scopepop", "showfft")));
	    m.addItem(scopeRMSMenuItem = new CheckboxMenuItem(LS("Show RMS Average"),
		    new MyCommand("scopepop", "showrms")));
	    ...
	    m.addItem(scopeSelectYMenuItem = new CheckboxAlignedMenuItem(LS("Select Y"),
		    new MyCommand("scopepop", "selecty")));
	    m.addItem(scopeResistMenuItem = new CheckboxMenuItem(LS("Show Resistance"),
		    new MyCommand("scopepop", "showresistance")));
	}
	return m;
    }
	...
	if (mouseMode != CirSim.MODE_DRAG_ROW && mouseMode != CirSim.MODE_DRAG_COLUMN) {
		...
		CircuitElementSupport.drawPost(g, postDrawList.get(i));
	}
