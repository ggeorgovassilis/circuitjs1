...
public class VCCSElm extends ChipElm {
    ...
    double getLimitStep() {
	// get limit on changes in voltage per step. be more lenient the more iterations
	// we do
	...
	if (n == 0) {
	    EditInfo ei = new EditInfo("<a href=\"customfunction.html\" target=\"_blank\">Output Function</a>", 0, -1,
		    -1);
	    ei.text = exprString;
	    return ei;
	}
