...
public class AndGateElm extends GateElm {
	...
	if (useEuroGates()) {
	    ...
	    // 22 = bottom left
	    Point triPoints[] = CircuitElementSupport.newPointArray(23);
	    CircuitElementSupport.interpPoint2(lead1, lead2, triPoints[0], triPoints[22], 0, hs2);
	    int i;
	    for (i = 0; i != 10; i++) {
		double a = i * .1;
		double b = Math.sqrt(1 - a * a);
		CircuitElementSupport.interpPoint2(lead1, lead2, triPoints[i + 1], triPoints[21 - i], .5 + a / 2, b * hs2);
	    }
